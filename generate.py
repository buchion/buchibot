...
def Create_Robot():
    ...
    pyrosim.Send_Joint(name = "Torso_BackLeg", parent= "Torso", child = "BackLeg" , type = "fixed", position = [0,0,0])
    pyrosim.Send_Cube(name="BackLeg", pos = [0, 1, 0.5], size=[length, width, height])

    pyrosim.Send_Joint(name = "Torso_FrontLeg", parent= "Torso", child = "FrontLeg", type = "fixed", position = [0,0,0])
